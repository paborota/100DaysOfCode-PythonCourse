...
"""
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    UPDATE CONSTANTS IN OTHER CLASS FILES OR PROGRAM WILL NOT FUNCTION AT ALL
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
"""
...
flights_found = flight_search.find_flight(sheet_data, departure_iata, date_boundary, currency)
...
notification_manager.send_email_alert(flights=flights)
